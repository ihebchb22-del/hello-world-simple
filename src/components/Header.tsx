      ...
      <div className="container flex items-center justify-between h-14 sm:h-16 md:h-20">
        ...
        <div className="flex items-center gap-1 sm:gap-1.5 md:gap-2">
          ...
          <button
            ...
            className="flex items-center justify-center h-10 w-10 text-foreground hover:text-primary transition-colors touch-manipulation"
          ...
          <Link
            to="/wishlist"
            className={`relative flex items-center justify-center h-10 w-10 transition-colors touch-manipulation ${
              location.pathname === "/wishlist" ? "text-primary" : "text-foreground hover:text-primary"
            }`}
          ...
          <Link
            to="/shop"
            className="relative flex items-center justify-center h-10 w-10 text-foreground hover:text-primary transition-colors touch-manipulation"
